...
return array(
	...
	'api_url'        => array(
		...
		'options'     => array(
			...
			'http://api-staging.paytomorrow.com'=> 	 __( 'Stagging', 'wc_paytomorrow' )
			)
	),
	'api_username'   => array(
    ...
    'pt_status_processing'          => array(
        'title'       => __( 'Processing Status (Advanced)', 'wc_paytomorrow' ),
        'type'        => 'checkbox',
        'label'       => __( 'Processing on Ready to Settle', 'wc_paytomorrow' ),
        'default'     => 'no',
        /* translators: %s: wc_get_log_file_path( 'paytomorrow' ) */
        'description' => __( 'The order status changes to processing after the application goes into ready for settle state', 'wc_paytomorrow' ),
    )
);
