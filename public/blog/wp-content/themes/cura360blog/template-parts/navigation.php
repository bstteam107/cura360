		...
		<div class="pagination-single-inner">
			...
			if ( $prev_post ) {
				...
				<a class="previous-post" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>">
					...
					<span class="title"><span class="title-inner"><?php //echo wp_kses_post( get_the_title( $prev_post->ID ) ); ?>Prev Post</span></span>
				</a>
			...
			if ( $next_post ) {
				...
				<a class="next-post" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>">
					<span class="arrow" aria-hidden="true"><i class="fa fa-angle-right"></i></span>
						<span class="title"><span class="title-inner"><?php //echo wp_kses_post( get_the_title( $next_post->ID ) ); ?>Next Post</span></span>
				</a>
				<?php
			}
			?>
