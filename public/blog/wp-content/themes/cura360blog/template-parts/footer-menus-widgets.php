	...
	<div class="blog-nav-widgets-wrapper header-footer-group">
		...
		<div class="blog-inner">
			...
			if ( $has_footer_menu || $has_social_menu ) {
				?>
				<div class="blog-top<?php echo $footer_top_classes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static output ?>">
					<?php if ( $has_footer_menu ) { ?>

						<nav aria-label="<?php esc_attr_e( 'Footer', 'twentytwenty' ); ?>" class="footer-menu-wrapper">

							<ul class="blog-menu reset-list-style">
								<?php
								wp_nav_menu(
									array(
										'container'      => '',
