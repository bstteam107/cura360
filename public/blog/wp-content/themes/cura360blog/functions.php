...
function add_theme_scripts() {
  ...
  wp_enqueue_style( 'slider', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), '4.0', 'all');
  
  wp_enqueue_script( 'script', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array ( 'jquery' ), 4.0, true);
...
function custom_newsletter(){
	$arg = 
		array(
        'name'          => __( 'Footer Newsletter', 'textdomain' ),
...
add_action( 'widgets_init', 'custom_newsletter' );
