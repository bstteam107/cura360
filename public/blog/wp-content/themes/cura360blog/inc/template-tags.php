...
function twentytwenty_edit_post_link( $link, $post_id, $text ) {
	...
	return '<!--<div class="post-meta-wrapper post-meta-edit-link-wrapper"><ul class="post-meta"><li class="post-edit meta-wrapper"><span class="meta-icon">' . twentytwenty_get_theme_svg( 'edit' ) . '</span><span class="meta-text"><a href="' . esc_url( $edit_url ) . '">' . $text . '</a></span></li></ul></div> -->';
...
function twentytwenty_get_post_meta( $post_id = null, $location = 'single-top' ) {
	...
	if ( $post_meta && ! in_array( 'empty', $post_meta, true ) ) {
		...
		<div class="post-meta-wrapper<?php echo esc_attr( $post_meta_wrapper_classes ); ?>">
			...
			<div class="blog-detail-share"><a href="#"><img src="https://cura360.com/blog/wp-content/uploads/icon-share.svg" alt=""></a>
                          <div class="blog-detail-social">
                            <div class="d-flex w-100 justify-content-between align-items-center h_50">                            	
                            	<a href="https://twitter.com/share?url=<?=esc_url( get_permalink() )?>" target="_blank"><img class="mr-3" src="https://cura360.com/blog/wp-content/uploads/icon-twitter-col.svg" alt=""></a>

                            	<a href="https://linkedin.com/shareArticle?url=<?=esc_url( get_permalink() )?>" target="_blank"><img class="mr-3" src="https://cura360.com/blog/wp-content/uploads/icon-linkedin-col.svg" alt=""></a>

                            	<a href="https://www.facebook.com/sharer/sharer.php?u=<?=esc_url( get_permalink() )?>" target="_blank"><img src="https://cura360.com/blog/wp-content/uploads/icon-facebook-col.svg" alt=""></a>
                            </div>
                          </div>
                        </div>
