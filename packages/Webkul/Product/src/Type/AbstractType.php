...
abstract class AbstractType
{
    ...
    public function getPriceHtml()
    {
        if ($this->haveSpecialPrice()) {
            ...
            . '<span class="special-price curaprice">' . core()->currency($this->evaluatePrice($this->getSpecialPrice())) . '</span>';
        } else {
            $html = '<span class="curaprice">' . core()->currency($this->evaluatePrice($this->product->price)) . '</span>';
        }
